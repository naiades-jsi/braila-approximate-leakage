...
cp  $HOME/NAIADES/Start/Networks/${NetworkRuns[$Mod]} "$TMPDIR" # TODO create file structure
DataDirectory="/scratch-shared/NAIADES/$Mod"  # TODO add your folder
